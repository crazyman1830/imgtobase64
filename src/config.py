...
class ConfigManager:
    ...
    def _load_from_env(self) -> Dict[str, Any]:
        ...
        if os.getenv('MAX_FILE_SIZE_MB'):
            env_config.setdefault('security', {})['max_file_size_mb'] = int(os.getenv('MAX_FILE_SIZE_MB'))
        
        if os.getenv('ENABLE_SECURITY_SCAN'):
            env_config.setdefault('security', {})['enable_content_scan'] = os.getenv('ENABLE_SECURITY_SCAN').lower() == 'true'
        
        if os.getenv('RATE_LIMIT_REQUESTS_PER_MINUTE'):
            env_config.setdefault('security', {})['rate_limit_requests_per_minute'] = int(os.getenv('RATE_LIMIT_REQUESTS_PER_MINUTE'))
        ...
        if os.getenv('CACHE_MAX_SIZE_MB'):
            env_config.setdefault('cache', {})['max_size_mb'] = int(os.getenv('CACHE_MAX_SIZE_MB'))
        
        if os.getenv('CACHE_MAX_AGE_HOURS'):
            env_config.setdefault('cache', {})['max_age_hours'] = int(os.getenv('CACHE_MAX_AGE_HOURS'))
        ...
        if os.getenv('MAX_CONCURRENT_PROCESSING'):
            env_config.setdefault('processing', {})['max_concurrent_files'] = int(os.getenv('MAX_CONCURRENT_PROCESSING'))
        
        if os.getenv('ENABLE_MEMORY_OPTIMIZATION'):
            env_config.setdefault('processing', {})['enable_memory_optimization'] = os.getenv('ENABLE_MEMORY_OPTIMIZATION').lower() == 'true'
        
        if os.getenv('PARALLEL_PROCESSING_WORKERS'):
            env_config.setdefault('processing', {})['cpu_workers'] = int(os.getenv('PARALLEL_PROCESSING_WORKERS'))
        ...
        if os.getenv('LOG_LEVEL'):
            env_config.setdefault('logging', {})['level'] = os.getenv('LOG_LEVEL').upper()
