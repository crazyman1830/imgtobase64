...
from .unified_config_manager import get_config_manager, UnifiedConfigManager
...
class LegacyAppConfig:
    ...
    def supported_formats(self) -> List[str]:
        return self._config_manager.get('processing.supported_formats', ['.png', '.jpg', '.jpeg', '.gif', '.bmp', '.webp'])
