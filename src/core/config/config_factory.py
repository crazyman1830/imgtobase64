...
class ConfigFactory:
    ...
    def from_env() -> AppConfig:
        ...
        env_mappings = {
            ...
            "IMG_CONVERTER_ENABLE_FILE_LOGGING": (
                "enable_file_logging",
                lambda x: x.lower() == "true",
            ),
            "IMG_CONVERTER_MAX_CONCURRENT_FILES": ("max_concurrent_files", int),
            "IMG_CONVERTER_ENABLE_MEMORY_OPTIMIZATION": (
            ...
            "IMG_CONVERTER_ENABLE_SECURITY_SCAN": (
        ...
        if supported_formats_env:
            try:
                ...
                print(
                    f"Warning: Invalid supported formats: {supported_formats_env} ({e})"
                )
