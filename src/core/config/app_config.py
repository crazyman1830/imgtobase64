...
class AppConfig:
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'AppConfig':
        ...
        valid_keys = {
            'max_file_size_mb', 'supported_formats', 'cache_enabled', 'cache_dir',
            'cache_max_size_mb', 'cache_max_age_hours', 'log_level', 'log_dir',
            'enable_file_logging', 'max_concurrent_files', 'enable_memory_optimization',
            'web_host', 'web_port', 'web_debug', 'enable_security_scan',
            'rate_limit_per_minute', 'temp_dir', 'data_dir'
        }
