...
class ServiceFactory:
    ...
    def create_image_conversion_service(self) -> ImageConversionService:
        ...
        try:
            ...
            raise ImageConverterError(f"Failed to create ImageConversionService: {str(e)}")
    ...
    def _create_image_converter(self) -> IImageConverter:
        ...
        from ..adapters.legacy_image_converter_adapter import LegacyImageConverterAdapter
