...
class DIContainer:
    ...
    def _register_core_services(self) -> None:
        ...
        self._register_singleton(
            "service_factory", lambda: ServiceFactory(self._config)
        )
    ...
    def _register_application_services(self) -> None:
        ...
        self._register_singleton(
            "image_conversion_service", self._create_image_conversion_service
        )

        # File handler service (singleton)
        self._register_singleton(
            "file_handler_service", self._create_file_handler_service
        )

        # Cache manager service (singleton)
        self._register_singleton(
            "cache_manager_service", self._create_cache_manager_service
        )
    ...
    def create_for_testing(
        cls, test_config: Optional[AppConfig] = None
    ) -> "DIContainer":
        """
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"DIContainer(registered_services={len(registered_services)}, "
