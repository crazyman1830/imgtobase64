...
class FileSystemError(ImageConverterError):
    ...
    def __init__(
        ...
        super().__init__(
            message, error_code or ErrorCode.FILE_SYSTEM_ERROR, context, user_message
        )
...
class FileNotFoundError(FileSystemError):
    ...
    def __init__(self, file_path: str):
        ...
        context = {"file_path": file_path, "operation": "file_access"}
...
class DirectoryNotFoundError(FileSystemError):
    ...
    def __init__(self, directory_path: str):
        ...
        context = {"directory_path": directory_path, "operation": "directory_access"}
...
class FileExistsError(FileSystemError):
    ...
    def __init__(self, file_path: str):
        ...
        context = {"file_path": file_path, "operation": "file_creation"}
