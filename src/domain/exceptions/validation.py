...
class ValidationError(ImageConverterError):
    ...
    def __init__(
        ...
        super().__init__(
            message, error_code or ErrorCode.VALIDATION_ERROR, context, user_message
        )
...
class UnsupportedFormatError(ValidationError):
    ...
    def __init__(
        ...
        supported_list = (
            ...
            else "PNG, JPG, JPEG, GIF, BMP, WEBP"
        )
...
class FileSizeError(ValidationError):
    ...
    def __init__(
        self, file_path: str, file_size: int, max_size: int, size_unit: str = "bytes"
    ):
...
class InvalidInputError(ValidationError):
    ...
    def __init__(
        ...
        message = (
            f"Invalid input parameter '{parameter_name}' with value '{parameter_value}'"
        )
