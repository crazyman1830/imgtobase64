...
class CacheError(ImageConverterError):
    ...
    def __init__(
        ...
        super().__init__(
            message, error_code or ErrorCode.CACHE_ERROR, context, user_message
        )
...
class CacheReadError(CacheError):
    ...
    def __init__(self, cache_key: str, original_error: Optional[Exception] = None):
...
class CacheCorruptionError(CacheError):
    ...
    def __init__(self, cache_key: str, corruption_details: Optional[str] = None):
        ...
        context = {"cache_key": cache_key, "corruption_details": corruption_details}
