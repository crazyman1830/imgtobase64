...
class WebHandlers:
    ...
    def _handle_request(self, handler_func) -> Result:
        ...
        try:
            ...
            self.logger.error(f"Application error: {str(e)}", extra={
    ...
    def _convert_from_base64_impl(self) -> Result:
        ...
        try:
            ...
            if not self._validate_base64_data(base64_data):
                return Result.failure(ValidationError('유효하지 않은 Base64 이미지 데이터입니다.'))
            ...
            return Result.failure(ProcessingError(f'변환 중 오류가 발생했습니다: {str(e)}'))
    ...
    def _validate_base64_impl(self) -> Result:
        ...
        try:
            ...
            return Result.failure(ValidationError(f'검증 중 오류가 발생했습니다: {str(e)}'))
    ...
    def _get_supported_formats_impl(self) -> Result:
        ...
        try:
            ...
            return Result.failure(ProcessingError(f'지원 형식 조회 중 오류가 발생했습니다: {str(e)}'))
    ...
    def _get_cache_stats_impl(self) -> Result:
        ...
        try:
            ...
            return Result.failure(ProcessingError(f'캐시 통계 조회 중 오류가 발생했습니다: {str(e)}'))
    ...
    def _clear_cache_impl(self) -> Result:
        ...
        try:
            ...
            return Result.failure(ProcessingError(f'캐시 삭제 중 오류가 발생했습니다: {str(e)}'))
    ...
    def _serialize_processing_options(self, options: Optional[ProcessingOptions]) -> Optional[Dict[str, Any]]:
        """
    ...
    def _format_error_response(self, error: Exception) -> Dict[str, Any]:
        ...
        formatted_response, _ = self.error_formatter.format_error_response(error, context)
